...
const VALUE_MG_ROOK: i32 = 477;
const VALUE_MG_QUEEN: i32 = 1025;

const VALUE_EG_PAWN: i32 = 94;
const VALUE_EG_KNIGHT: i32 = 281;
const VALUE_EG_BISHOP: i32 = 297;
const VALUE_EG_ROOK: i32 = 512;
const VALUE_EG_QUEEN: i32 = 936;

const VALUE_KING: i32 = 0;

pub static MG_VALUES: [i32; 10] = [
    0,
    VALUE_KING,
    VALUE_MG_QUEEN,
    VALUE_MG_KNIGHT,
...
const EG_KING_TABLE: [i32; 64] = [
    -300, -200, -200, -200, -200, -200, -200, -300, -200, -150, -150, -150, -150, -150, -200, -200,
    -200, -150, -100, -100, -100, -100, -150, -200, -200, -150, -100, 0, 0, -100, -150, -200, -200,
    -150, -100, 0, 0, -100, -150, -200, -200, -150, 100, -100, -100, -100, -150, -200, -200, -150,
    -150, -150, -150, -150, -200, -200, -300, -200, -200, -200, -200, -200, -200, -300,
];

pub static MG_TABLES: [[i32; 64]; 10] = [
    [0; 64],
    MG_KING_TABLE,
    MG_QUEEN_TABLE,
    MG_KNIGHT_TABLE,
...
pub static EG_TABLES: [[i32; 64]; 10] = [
    [0; 64],
    EG_KING_TABLE,
    EG_QUEEN_TABLE,
    EG_KNIGHT_TABLE,
...
pub const GAME_PHASE_INC: [i32; 10] = [0, 0, 4, 1, 0, 1, 0, 2, 0, 0];
